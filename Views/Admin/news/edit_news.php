...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $thumbnail_url = htmlspecialchars($_POST['thumbnail_url']);
...
<form method="POST">
    ...
    <div class="mb-3">
        ...
        <textarea name="content" class="form-control" rows="5" required><?= htmlspecialchars($news_article["content"]) ?></textarea>
    </div>
    ...
    <div class="mb-3">
        ...
        <select name="category_id" class="form-select" required>
            <option value="<?= $news_article_cat["id"] ?>"><?= htmlspecialchars($news_article_cat["name"]) ?></option>
            <?php foreach ($categories as $cat): ?>
                <?php if(htmlspecialchars($news_article_cat["name"]) === htmlspecialchars($cat['name'])){ continue; }?>
